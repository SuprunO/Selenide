...
public class Site16a {

    public String product1 = "#myCarousel21935515 > div.carousel-inner.owl-carousel.owl-theme > div.owl-wrapper-outer > div.owl-wrapper > div.owl-item:nth-child(1) > div.active.item > div.product-grid > div.row > div...col-sm-3.col-xs-6:nth-child(1) > div.clearfix.product.product-hover > div.right > div.name > a";
    public String ColorField = "#product>div:nth-of-type(1)>select";
    public String ColorOption = "#product>div:nth-of-type(1)>select>option:last-child";
    ...
    public String MinicartViewCartButton = "#col-sm-17 > div.alert.alert-success > a:nth-child(2)";

    public String CartCheckoutButton = "#col-sm-26 > a.btn.btn-primary";
