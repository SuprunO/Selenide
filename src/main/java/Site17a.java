...
public class Site17a {

    public String product1 = "#content > div.row > div.col-lg-3.col-md-3.col-sm-6.col-xs-12.product-grid.product-layout:nth-child(1) > div.product-thumb > div > div.caption > h4 > a";
    ...
    public String CartCheckoutButton = "#content > div.buttons.clearfix > div.pull-right > a.btn.btn-primary";
