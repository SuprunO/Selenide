...
public class Site22 {
    ...
    public String product1 = "#content > div.feature_container > div.row > div.col-lg-3.col-md-3.col-sm-6.col-xs-12.product-layout:nth-child(1) > div.product-thumb.transition > div.caption > h4 > a";
